...
### Including images
Code chunks are also used for including images, with `include_graphics` from the `knitr` package, as in Figure \@ref(fig:HarrisburgU-logo)

```{r HarrisburgU-logo, fig.cap="HarrisburgU logo", out.width='50%', fig.align='center'}
knitr::include_graphics("figures/HarrisburgU_Logo.png")
```
...
Then you can reference that variable as the value of `out.extra` to rotate images, as in Figure \@ref(fig:HarrisburgU-logo-rotated).

```{r HarrisburgU-logo-rotated, out.extra=rotate180, fig.cap="HarrisburgU logo, rotated", out.width='50%', fig.align='center', echo=FALSE}
knitr::include_graphics("figures/HarrisburgU_Logo.png")
```
